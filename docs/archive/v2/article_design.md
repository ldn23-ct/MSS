...
> 文档状态：项目 v2 归档中已实现并冻结的 article v1 实验设计。
> 职责：记录旧 E0–E5 实验分类、条件规模和论文图表逻辑。
> 上游：Geant4 核心事件级数据能力。
> 下游：冻结的 `article_experiment_automation.md` 和 article v1 结果复现；项目级导航见 [`project_structure.md`](../../project_structure.md)。
